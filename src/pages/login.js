      ...
      <div className={containerClasses} id="containerID">
        <div className="form-container sign-up-container">
          <form className="LoginForm" action="#">
            ...
            <div className="social-container">
              <a href="#" className="loginA social"><i className="fab fa-facebook-f"></i></a> <a
                href="#" className="loginA social"><i className="fab fa-google-plus-g"></i></a> <a
                  href="#" className="loginA social"><i className="fab fa-linkedin-in"></i></a>
            </div>
            <span className="loginSpan" >or use your email for registration</span> <input className="loginI" type="text"
              placeholder="Name" /> <input className="loginI" type="email" placeholder="Email" /> <input
              className="loginI" type="password" placeholder="Password" />
        ...
        <div className="form-container sign-in-container">
          <form className="LoginForm" action="#">
            ...
            <span className="loginSpan">or use your account</span> <input className="loginI" type="email"
              placeholder="Email" /> <input className="loginI" type="password"
                placeholder="Password" /> <a className="loginA" href="#">Forgot your password?</a>
            <button className="loginB" id="login" onClick={this.loginClick}>Sign In</button>
          </form>
        </div>
