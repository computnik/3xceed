            ...
            <div className="row justify-content-center">
              <div className="col-lg-8 text-center">
                ...
                <p className="text-white-50 mb-4">
                  We give grocery items their own identity that allows tracking
                  them in real-time throughout the whole Supply-Chain.
                  Manufacturers and Retailers can improve their Stock Management
                  in order to save money and minimize food waste. While
                  consumers can use the IOT enabled mobile application to
                  digitally connect their kitchen and make the most of it.
                </p>
                <a
            ...
            <div className="row">
              <div className="col-lg-3 col-md-6 text-center">
                <div className="mt-5">
                  ...
                  <p className="text-muted mb-0">
                    Automated solution to access any step of suppy chain on your
                    smartphone
                  </p>
                </div>
              </div>
              <div className="col-lg-3 col-md-6 text-center">
                <div className="mt-5">
                  ...
                  <h3 className="h4 mb-2">
                    Digitally connected to your smart devices
                  </h3>
                  <p className="text-muted mb-0">
                    Integrated support for all smart devices to check in and
                    check out.
                  </p>
                </div>
              </div>
              <div className="col-lg-3 col-md-6 text-center">
                <div className="mt-5">
                  ...
                  <p className="text-muted mb-0">
                    Check the overview with push notifications of all products
                    anytime with predictive suggestions
                  </p>
                </div>
              </div>
              <div className="col-lg-3 col-md-6 text-center">
                <div className="mt-5">
                  ...
                  <p className="text-muted mb-0">
                    All solutions with one goal of saving time, money and
